...
type MessageListRequest struct {
	...
	ToUserId int64 `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"` // target user_id
	Token    int64 `protobuf:"varint,3,opt,name=token,proto3" json:"token,omitempty"`                         // last message time
}
...
func (x *MessageListRequest) GetToken() int64 {
	if x != nil {
		return x.Token
	}
	return 0
...
type MessageListResponse struct {
	...
	StatusCode  int32      `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`   // status code
	StatusMsg   string     `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`       // status message
	MessageList []*Message `protobuf:"bytes,3,rep,name=message_list,json=messageList,proto3" json:"message_list,omitempty"` // message list
}
...
type Message struct {
	...
	FromUserId int64  `protobuf:"varint,3,opt,name=from_user_id,json=fromUserId,proto3" json:"from_user_id,omitempty"` // source user id
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty"`                            // message content
	CreateTime int64  `protobuf:"varint,5,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`   // message create time
}
...
type MessageActionRequest struct {
	...
	UserId     int64  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`             // user_id
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`     // target user_id
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"` // action type
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty"`                          // message content
}
...
var file_message_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x61, 0x0a, 0x12, 0x4d, 0x65, 0x73, 0x73,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8a, 0x01, 0x0a, 0x13,
	...
	0x88, 0x01, 0x0a, 0x14, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x03, 0x50, 0x75, 0x74,
	0x12, 0x1d, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1e, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*MessageListResponse)(nil),   // 1: message.MessageListResponse
...
var file_message_proto_depIdxs = []int32{
	2, // 0: message.MessageListResponse.message_list:type_name -> message.Message
	0, // 1: message.MessageService.List:input_type -> message.MessageListRequest
	3, // 2: message.MessageService.Put:input_type -> message.MessageActionRequest
	1, // 3: message.MessageService.List:output_type -> message.MessageListResponse
	4, // 4: message.MessageService.Put:output_type -> message.MessageActionResponse
